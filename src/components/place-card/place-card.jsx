...
class PlaceCard extends React.PureComponent {
  ...
  render() {
    ...
    return <React.Fragment>
      <article className="cities__place-card place-card" onMouseEnter={() => this.props.handleHover(this.props.cardId)} onMouseLeave={() => this.props.handleHover(this.props.cardId)}>
